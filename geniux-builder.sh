...
display_usage() {
    ...
    echo -e "             rocko, sumo, thud, warrior, zeus, dunfell, gatesgarth, hardknott, honister, kirkstone,"
    echo -e "             langdale, mickledore, nanbield, scarthgap, styhead, walnascar, whinlatter. Default: scarthgap"
    echo -e "           Check available branches at https://github.com/carlesfernandez/meta-gnss-sdr"
    echo -e " manifest  Geniux version manifest: 21.02, 21.08, 22.02, 22.06, 23.04, 24.02, 25.04, latest. Default: latest"
