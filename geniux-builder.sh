...
display_usage() {
    ...
    echo -e "Options:"
    echo -e " version   Geniux version: rocko, sumo, thud, warrior, zeus,"
    echo -e "           dunfell, gatesgarth, hardknott, honister. Default: dunfell"
    echo -e "           Check available branches at https://github.com/carlesfernandez/meta-gnss-sdr"
    echo -e " manifest  Geniux version manifest: 21.02, 21.08, 22.02, latest. Default: latest"
